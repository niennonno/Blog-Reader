...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCG9BJx7fTlaZHq5wnJqDOyXJylhZ8uUgc")!
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        fetchRequest.fetchBatchSize = 20                //number of blog items depicted in the view
